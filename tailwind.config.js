...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'neon': '0 0 2px rgba(74, 43, 116, 0.15), 0 0 8px rgba(74, 43, 116, 0.1)',
        'neon-purple': '0 0 2px rgba(138, 99, 255, 0.15), 0 0 8px rgba(138, 99, 255, 0.1)',
        'neon-dark': '0 0 2px rgba(43, 25, 68, 0.15), 0 0 8px rgba(43, 25, 68, 0.1)',
        'neon-yellow': '0 0 2px rgba(239, 202, 78, 0.15), 0 0 8px rgba(239, 202, 78, 0.1)',
        'neon-red': '0 0 2px rgba(255, 74, 110, 0.15), 0 0 8px rgba(255, 74, 110, 0.1)',
        'neon-cyan': '0 0 2px rgba(78, 234, 170, 0.15), 0 0 8px rgba(78, 234, 170, 0.1)',
        'inner-glow': 'inset 0 0 2px rgba(138, 99, 255, 0.08), inset 0 0 6px rgba(138, 99, 255, 0.05)',
        'glass': '0 4px 16px 0 rgba(0, 0, 0, 0.25)',
        '3d': '0 4px 8px rgba(0, 0, 0, 0.2), 0 2px 3px rgba(0, 0, 0, 0.15)',
        'elegant': '0 2px 8px rgba(0, 0, 0, 0.15)',
        'elegant-lg': '0 4px 16px rgba(0, 0, 0, 0.2)',
      },
      keyframes: {
        fadeIn: {
          from: { opacity: 0 },
