    ...
    <main className="flex-1 text-white">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-black via-gaming-900 to-black">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(138,99,255,0.03),transparent_50%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(74,43,116,0.04),transparent_60%)]" />
        </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                ...
                <span className="text-xs font-medium text-white/80 tracking-wider uppercase">Professional Gaming</span>
              </div>
              
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1]">
                <span className="block text-white mb-2">Precision</span>
                <span className="block bg-gradient-to-r from-accent-secondary to-accent-primary bg-clip-text text-transparent">Redefined</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  href="/search/"
                  className="group inline-flex items-center justify-center px-8 py-4 bg-white text-black rounded-full font-medium hover:bg-white/90 transition-all duration-300 hover:scale-[1.02]"
                  prefetch={false}
                >
                ...
                <Link
                  href="/about-us"
                  className="inline-flex items-center justify-center px-8 py-4 border border-white/20 text-white rounded-full font-medium hover:bg-white/5 transition-all duration-300"
                  prefetch={false}
                >
                  Learn More
                </Link>
            ...
            {/* Right - Clean Product Display */}
            <div className="relative hidden md:flex items-center justify-center">
              <div className="relative w-full max-w-md aspect-square">
                {/* Subtle glow effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-accent-secondary/20 to-accent-primary/20 rounded-full blur-3xl opacity-30" />
                
                <div className="relative">
                  <Image
                    src="/images/mousepad_1x1.png"
                    alt="47Gear Premium Mousepad"
                    width={500}
                    height={500}
                    className="relative z-10 drop-shadow-2xl transform hover:scale-105 transition-transform duration-700"
                    priority
                  />
                </div>
                
                {/* Floating badge */}
                <div className="absolute top-8 -right-4 bg-white text-black px-6 py-3 rounded-full font-bold text-sm shadow-2xl">
                  Pro Choice
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-20 space-y-4">
              ...
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Engineered with precision. Designed for victory.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group p-8 rounded-2xl border border-white/5 hover:border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">Precision Tracking</h3>
                <p className="text-white/50 leading-relaxed">Micro-textured surface engineered for pixel-perfect accuracy and responsive control.</p>
              </div>
              ...
              <div className="group p-8 rounded-2xl border border-white/5 hover:border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500">
                ...
                <p className="text-white/50 leading-relaxed">Premium materials that maintain performance through years of intensive use.</p>
              </div>
              ...
              <div className="group p-8 rounded-2xl border border-white/5 hover:border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500">
                ...
                <p className="text-white/50 leading-relaxed">Ergonomic design reduces fatigue during marathon gaming sessions.</p>
              </div>
              ...
              <div className="group p-8 rounded-2xl border border-white/5 hover:border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">Your Style</h3>
                <p className="text-white/50 leading-relaxed">Multiple designs to perfectly complement your gaming setup.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Product Categories Section - Clean & Minimalist */}
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Find the perfect mousepad for your setup
              </p>
            </div>
            
            {/* Collections Grid - Minimal Design */}
            <div className="grid md:grid-cols-3 gap-6">
              {/* Gaming Collection */}
              <Link href="/search/gaming-collection" className="group block" prefetch={false}>
