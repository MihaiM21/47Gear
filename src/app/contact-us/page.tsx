          ...
          <div className="space-y-8">
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="font-semibold text-white mb-1">Sediul Nostru</h3>
                    <p className="text-white/60">123 Gaming Street, Tech City, GR 12345</p>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-white/60">Sâmbătă</span>
                  <span className="text-white font-medium">10:00 - 16:00</span>
                </div>
                <div className="h-px bg-white/10"></div>
                <div className="flex justify-between items-center">
                  <span className="text-white/60">Duminică</span>
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 hover:border-white/20 transition-all duration-500">
              ...
              <p className="text-white/60">Toate produsele vin cu o garanție de 1 an împotriva defectelor. Produsele premium au garanții extinse.</p>
            </div>
          </div>
        </div>
      </div>
