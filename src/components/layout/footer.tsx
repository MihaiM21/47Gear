          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
            ...
            <div className="md:col-span-4 space-y-4">
              ...
              <div className="flex gap-4 pt-2">
                ...
                <a href="https://www.instagram.com/47gear.ro/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Instagram">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.facebook.com/profile.php?id=61587469140959" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Facebook">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="https://www.tiktok.com/@47gear.ro?lang=ro-RO" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="TikTok">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-3">
                <li><Link href="/about-us" className="text-sm text-white/50 hover:text-white transition-colors">About Us</Link></li>
                <li><Link href="/contact-us" className="text-sm text-white/50 hover:text-white transition-colors">Contact</Link></li>
                <li><a href="https://account.47gear.ro" className="text-sm text-white/50 hover:text-white transition-colors">My Account</a></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="/return-policy" className="text-sm text-white/50 hover:text-white transition-colors">Return Policy</Link></li>
              </ul>
            </div>
