  ...
  return (
    <footer className="bg-black border-t border-gray-800 pt-12 pb-8 text-gray-300">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a href="#" className="text-gaming-400 hover:text-accent-primary transition-colors">
            ...
            <ul className="space-y-3">
              {menu.length > 0 ? (
                ...
                <>
                  ...
                  <li><Link href="/search" className="text-gaming-400 hover:text-accent-primary transition-colors">Products</Link></li>
          ...
          <div>
            ...
            <p className="text-sm text-gaming-400 mb-4">We are a company dedicated to providing the best gaming accessories.</p>
            <p className="text-sm text-gaming-400 mb-4">Our mission is to enhance your gaming experience with high-quality products.</p>
          </div>

          {/* Newsletter */}
          {/* <div>
            <h3 className="font-bold text-white mb-4">Stay Updated</h3>
            <p className="text-sm text-gaming-400 mb-4">Subscribe to get special offers, free giveaways, and product launches.</p>
            <form className="flex">
              <input 
                type="email" 
              ...
              <button 
                type="submit" 
                className="bg-accent-primary hover:bg-accent-primary/90 text-white rounded-r-md px-4 py-2 text-sm font-medium transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gaming-800 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between">
