              ...
              {images.map((image, index) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex-shrink-0 h-20 w-20 overflow-hidden rounded-lg border-2 transition-all duration-300 ${isActive
        ...
        {isZoomed && (
          ...
          >
            ...
            <button
              ...
              className="absolute top-24 right-4 md:top-24 md:right-6 z-[60] p-3 rounded-full bg-black/70 hover:bg-black border border-white/20 transition-all flex items-center justify-center group hover:scale-105 shadow-2xl"
              aria-label="Close zoom"
              type="button"
            >
              <span className="hidden md:block mr-2 text-white font-medium text-sm group-hover:text-red-400 transition-colors">Close</span>
              <XMarkIcon className="h-6 w-6 md:h-8 md:w-8 text-white group-hover:text-red-400 transition-colors" />
            </button>
